...
part of 'committee_information_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CommitteeInformationEntity _$CommitteeInformationEntityFromJson(
    Map<String, dynamic> json) {
  return CommitteeInformationEntity(
    json['Validator'] == null
        ? null
    ...
    json['BlockReward'] as int,
    json['TotalDelegation'] as num,
    json['TotalDelegationByOperator'] as num,
  );
}

Map<String, dynamic> _$CommitteeInformationEntityToJson(
        CommitteeInformationEntity instance) =>
    <String, dynamic>{
