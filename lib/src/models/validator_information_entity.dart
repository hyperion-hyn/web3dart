...
part 'validator_information_entity.g.dart';


@JsonSerializable()
class ValidatorInformationEntity extends Object {
  ...
  factory ValidatorInformationEntity.fromJson(Map<String, dynamic> srcJson) => _$ValidatorInformationEntityFromJson(srcJson);

  Map<String, dynamic> toJson() => _$ValidatorInformationEntityToJson(this);
